...
<body
        ...
        <div class="h-19">
            ...
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700"
                ...
                <img src=" {{ asset('assets/img/logo-ct.png') }}"
                    ...
                    alt="main_logo" />
                <span class="ml-1 font-semibold transition-all duration-200 dark:text-white ease-nav-brand">Argon
                    Dashboard 2</span>
            </a>
        </div>
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="w-full mt-4">
                    <h6 class="pl-6 ml-2 font-bold leading-tight uppercase dark:text-white text-xs opacity-60">Account
                        pages</h6>
                </li>

                <li class="mt-0.5 w-full">
                    <a class="py-2.7 bg-blue-500/13 dark:text-white dark:opacity-80  text-sm ease-nav-brand my-0 mx-2 flex items-center rounded-lg whitespace-nowrap px-4 font-semibold text-slate-700 transition-colors"
    ...
    <!--aparente sector clave para copiar-->
    ...
    <div fixed-plugin>
        ...
        <div fixed-plugin-card
            ...
            <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
                ...
                <p class="block mt-2 leading-normal dark:text-white dark:opacity-80 text-sm xl:hidden">You can change
