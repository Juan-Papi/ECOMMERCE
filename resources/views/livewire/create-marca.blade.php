                ...
                <div
                    ...
                    <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                        <div class="flex items-center">
                            <p class="mb-0 dark:text-white/80">Añadir editorial</p>
                            <button type="button"
                    ...
                    <div class="flex-auto p-6">
                        <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-sm">Informacion de la editorial</p>
                        <div class="flex flex-wrap -mx-3">
